...
const Contact = () => {
    ...
    return(
        <div className="contact-pages-content-main-wraper">
            <Header />
                    ...
                    <div className="container py-5">
                        ...
                        <nav aria-label="breadcrumb animated slideInDown">
                            <ol className="breadcrumb text-uppercase mb-0">
                                ...
                                <li className="breadcrumb-item text-primary active">Contact</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div className="row g-4">
                <div className="col-lg-4">
                    <div className="h-100 bg-light rounded d-flex align-items-center p-5">
                        <div className="d-flex flex-shrink-0 align-items-center justify-content-center rounded-circle bg-white contact-us-icon-with-text">
                ...
                <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div className="h-100 iframe-map">
